    ...
    <>
      ...
      <main aria-hidden={isModalOpen}>
        ...
        <nav className="nav" id="nav" aria-label="Site navigation">
          ...
          <button className="nav-cta" onClick={openModal} aria-label="Open private access request">
            Request Access
          </button>
        </nav>
        ...
        <section id="hero" aria-label="Introduction">
          <div className="hero-inner">
            <div className="hero-text">
              ...
              <button className="btn fade-in delay-4 visible" onClick={openModal} aria-label="Open private access request">
                Request Access
              </button>
            </div>
          ...
          <div className="positioning-inner">
            <div className="positioning-text">
              ...
              <div className="body-text fade-in" style={{ marginTop: '2.75rem' }}>
                ...
                <p>My work examines how lifestyle, space, and emerging science come together to support vitality, mental clarity, and long-term health.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="what-inner">
            ...
            <div className="pillars-grid">
              ...
              <div className="pillar fade-in delay-2">
                ...
                <p className="pillar-body">Advisory on initiatives integrating wellbeing, sustainability, and human behavior into policy and future-forward environments.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="differentiation" aria-label="How I Work">
          <div className="diff-inner">
            ...
            <div className="divider fade-in"></div>
            <div className="body-text fade-in" style={{ marginTop: '2.75rem', maxWidth: 'var(--narrow-max)' }}>
              <p>My work brings together cellular optimization, advanced aesthetics, nervous system regulation, and environmental design.</p>
              <p>Alongside this, my work draws from biotechnology, epigenetics, and neuroaesthetics, translating emerging science into practical, refined applications.</p>
          ...
          <div className="about-inner">
            <div className="about-grid">
              <div className="about-text">
                ...
                <div className="divider fade-in"></div>
                <div className="body-text fade-in" style={{ marginTop: '2.75rem' }}>
                  <p>Birgit Bauer Wöhlers is a strategic advisor whose practice is rooted in longevity science, cellular optimization, and regenerative aesthetics.</p>
                  ...
                  <p>She is the founder of <span className="kalos">KALOS</span>, established in 2015 to advance longevity science, biotechnology, and regenerative wellbeing. Its work moves across research, product development, and private practice.</p>
                  <p>Her work extends to individuals, institutions, and hospitality groups across the Americas, the Middle East, and Europe.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="access" aria-label="Access">
          <div className="access-inner">
            <div className="access-content">
              ...
              <h2 className="section-heading section-heading--light fade-in" style={{ marginTop: '2.75rem' }}>
                Access is limited.
              </h2>
              <div className="body-text body-text--light fade-in" style={{ marginTop: '2.5rem', marginBottom: '3rem' }}>
              ...
              <button className="btn btn--light fade-in" onClick={openModal} aria-label="Open private access request">
                Request Access
              </button>
            </div>
          </div>
        ...
        <footer aria-label="Footer">
          <div className="footer-inner">
            ...
            <div className="footer-social">
              <a href="https://instagram.com/thebiohackingnmd" target="_blank" rel="noopener noreferrer">Instagram</a>
              <a href="https://linkedin.com/in/birgitbauerwohlers" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
          </div>
        </footer>
      </main>
      ...
      >
        <div className="modal" ref={panelRef}>
          ...
          {!showSuccess ? (
            <div>
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="form-field">
                  ...
                  <input className="form-input" type="text" id="f-name" name="name" autoComplete="name" required />
                </div>
                <div className="form-field">
                  <label className="form-label" htmlFor="f-email">Email / Preferred Contact</label>
                  <input className="form-input" type="email" id="f-email" name="email" autoComplete="email" required />
                </div>
                <div className="form-field">
                  <label className="form-label" htmlFor="f-collaboration">Type of Collaboration</label>
                  <select className="form-select" id="f-collaboration" name="collaboration" required defaultValue="">
                ...
                <div className="form-field">
                  ...
                  <textarea className="form-textarea" id="f-request" name="request" rows={4} required></textarea>
                </div>
                <div className="form-footer">
                  ...
                  <span
                    ...
                    aria-live="polite"
                    style={{ opacity: isLoading ? 1 : 0, visibility: isLoading ? 'visible' : 'hidden', transition: 'opacity 0.3s ease', pointerEvents: 'none' }}
                  >
                    Sending…
                  </span>
                </div>
            ...
            <div className="form-success" role="alert" aria-live="assertive">
